...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            logging.info('Data Transformatin Initiated')
            # Defien which column should be ordinal-encoded and which should be  scaled
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            # Features divided into independent and dependent features
            ...
            logging.info('Exception is occured in initiate_datatransformation')
